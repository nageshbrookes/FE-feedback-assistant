          ...
          <div className={"flex flex-col h-full"}>
              ...
              <div className={"grow flex justify-center items-center"}>
                  <div className={"w-full md:max-w-[400px] px-4"}>
                      ...
                      <div>
                          <div className={"text-[32px] font-semibold text-center m-3"}>Login to account</div>
                          <div className={"text-[#4F4D55] text-center mb-6"}>Enter your credentials to access your account</div>
                      </div>
                      ...
                      <div>
                          ...
                          <div className={"flex justify-center my-5"}>
                              <span className={"font-medium text-sm text-[#6A5BC1]"}>Forgot Password?</span>
                          </div>
                          <div className={"mb-6"}>
                              <Button text={"Login"} style={"shadow-md w-full border text-sm p-2.5 rounded-[7px] bg-[#6A5BC1] text-white rounded-full"}/>
                          </div>
                          <div className={"flex justify-center"}>
                              <span className={"font-medium text-sm"}>Don’t have an account?</span>
                              <Link className={"font-medium text-sm ml-2 text-[#6A5BC1]"} href={"/signup"}>Create Account</Link>
                          </div>
