...

                    {
                        toggleState ? (
                            <div
                                ...
                                <Link className={"block py-2 px-3 hover:bg-gray-100"} href={"/#home"}>Home</Link>
                                <Link className={"block py-2 px-3 hover:bg-gray-100"} href={"/#works"}>Events</Link>
                                <Link className={"block py-2 px-3 hover:bg-gray-100"} href={"/#about"}>About</Link>
                                <Link className={"block py-2 px-3 hover:bg-gray-100"} href={"/#contact"}>Contact</Link>
                            </div>
                        ) : null
                    }
